...
const teamUserLi = document.querySelector('.tdr_team_user');
...
selectedUsersDiv.addEventListener('click', () => {
  ...
  searchInput.focus();
  // teamUserLi.addEventListener('click', () => {
...
//   // // Data items
//   if (!selectedUsers.find(u => u.id === list.id || u.name === list.name)) {
//     selectedUsers.push(list);
//     renderSelected();
//   }
//   dropdown.style.display = 'none';
...
//     const li = e.target
//     if (!selectedUsers.find(u => u.id === li.dataset.id || u.name === user.name)) {
//       selectedUsers.push(user);
//       renderSelected();
//     }
...
document.addEventListener('click', e => {
    ...
    const userName = String(li.dataset.name);
