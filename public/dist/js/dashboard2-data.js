...
$(document).ready(function() {
	...
	if($('#morris_extra_line_chart').length > 0)
        ...
        fillOpacity: 0.5,
		lineWidth:2,
		pointStrokeColors:['#528FEB', '#e2e2e2', '#bdbdbd'],
		behaveLikeLine: true,
		grid: true,
		gridLineColor: '#eee',
		hideHover: 'auto',
		lineColors: ['#528FEB', '#e2e2e2', '#bdbdbd'],
		resize: true,
	...
	if($('#morris_area_chart').length > 0)
		...
		Morris.Area({
			...
			lineWidth:0,
			fillOpacity: 1,
			pointStrokeColors:['#528FEB', '#ababab', '#cecece'],
			behaveLikeLine: true,
			grid: true,
			gridLineColor: '#eee',
			hideHover: 'auto',
			lineColors: ['#528FEB', '#ababab', '#cecece'],
			resize: true,
			redraw: true,
			smooth: true,
			gridTextColor:'#878787',
