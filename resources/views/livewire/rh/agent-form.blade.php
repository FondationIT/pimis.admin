        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="form-group mb-3 row align-items-center">
                    <label class="col-auto col-form-label fw-bold">Type d’agent :</label>
                    <div class="col-auto">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="isExternal" wire:model="isExternal" style="transform: scale(1.5); margin-right: 0.5rem;">
                    ...
                    <form wire:submit.prevent='submit' >
                        <div class="modal-body">
                            ...
                            <div class="form-row">
                                <div class="col-md-4 mb-10">
                                    <label for="name">Nom</label>
                                    <input type="text" class="form-control @error('firstname') is-invalid @enderror" wire:model.defer="state.firstname" name="firstname" placeholder="Nom">
                                    @error('firstname')
                                        <span class="text-red-600" role="alert">
                                            {{ $message }}
                                        </span>
                                ...
                                <div class="col-md-4 mb-10">
                                    ...
                                    <input type="text" class="form-control @error('lastname') is-invalid @enderror" wire:model.defer="state.lastname"  name="lastname" placeholder="Postnom">
                                    @error('lastname')
                                        <span class="text-red-600" role="alert">
                                            {{ $message }}
                                        </span>
                                ...
                                <div class="col-md-4 mb-10">
                                    <label for="middlename">Prenom</label>
                                    <input type="text" class="form-control @error('middlename') is-invalid @enderror" wire:model.defer="state.middlename" name="middlename" placeholder="Prenom">
                                    @error('middlename')
                                        <span class="text-red-600" role="alert">
                                            {{ $message }}
                                        </span>
                            ...
                            <div class="form-row">
                                <div class="col-md-6 mb-10">
                                    ...
                                    <input type="text" class="form-control @error('position') is-invalid @enderror" wire:model.defer="state.position" name="position" placeholder="Position" aria-describedby="inputGroupPrepend">
                                    @error('position')
                                        <span class="text-red-600" role="alert">
                                            {{ $message }}
                                        </span>
                            ...
                            <div class="form-row">
                                <div class="col-md-6 mb-10">
                                    <label for="service">Organization</label>
                                    <input type="text" class="form-control @error('organization') is-invalid @enderror" wire:model.defer="state.organization" name="organization" placeholder="Organisation" aria-describedby="inputGroupPrepend">
                                    @error('organization')
                                        <span class="text-red-600" role="alert">
                                            {{ $message }}
                                        </span>
                            ...
                            <div class="form-row">
                                <div class="col-md-6 mb-10">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control @error('contact') is-invalid @enderror" wire:model.defer="state.contact" name="contact" placeholder="Contact" aria-describedby="inputGroupPrepend">
                                    </div>
                                    @error('contact')
                                        <span class="text-red-600" role="alert">
                                            {{ $message }}
