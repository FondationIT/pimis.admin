<div x-data class="flex flex-col">
    <div class="w-full relative flex">
        <input x-ref="start" class="w-full pr-8 m-1 text-sm leading-4 block px-1 py-1 rounded border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50" type="date"
    ...
    <div class="w-full relative flex items-center">
        <input x-ref="end" class="w-full pr-8 m-1 text-sm leading-4 block px-1 py-1 rounded border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50" type="date"
