<div>
    <div class="modal fade" id="nPrixModalForms" tabindex="-1" role="dialog" wire:ignore.self aria-labelledby="exampleModalEditor" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Contrat CARD par article</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-row">
                            <div class="col-md-12 mb-10">
                                ...
                                <select class="form-control select2 @error('fournisseur') is-invalid @enderror" wire:model.defer="state.fournisseur" name="fournisseur">
                                    <option value=""></option>
                                    @foreach ($fournisseurs as $cat)
