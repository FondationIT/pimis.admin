<div>
    ...
    <div class="modal fade" tabindex="-1" id="chequeModalForms" role="dialog" wire:ignore.self aria-labelledby="exampleModalEditor" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Nouveaux cheque</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-8 mb-10">
                            <label for="num">Numero de cheque</label>
